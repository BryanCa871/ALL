...
class Sensor:
    ...
    def mostrarSensores():
        ...
        if sensores != []:
            table = PrettyTable()
            table.field_names = ["Nombre", "Tipo", "Ubicación", "Descripción", "Fecha de Creación"]

            for sensor in sensores:
                table.add_row([sensor["nombre"], sensor["tipo"], sensor["ubicacion"], sensor["descripcion"], sensor["fecha_creacion"]])
